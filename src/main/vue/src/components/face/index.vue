...
<div>
  <div class="body">
    ...
    <div>
      <el-select v-model="class_id" placeholder="请选择" style="">
        <el-option
      ...
      <el-button type="success" @click="come">入校</el-button>
      <el-button type="danger" @click="go">出校</el-button>
      <el-button type="info" @click="check">考勤</el-button>
    </div>
...
export default {
  ...
  methods:{
      ...
      axios.post("http://127.0.0.1:2020/face",
        ...
        //识别成功 停止轮询
          ...
          axios.get("student/find_one/" + this.id).then(res=>{
            ...
            axios.post("student/come",this.student).then(res=>{
              console.log(res)
            })
      ...
      axios.post("http://127.0.0.1:2020/face",
        ...
        //识别成功 停止轮询
          ...
          axios.get("student/find_one/" + this.id).then(res=>{
            ...
            axios.post("classes/stu_check?stu_id=" + this.student.id + "&class_id=" + this.class_id +"&time=" + time).then(res=>{
              console.log(res)
            })
    ...
    get_checks(){
      axios.get("classes/is_check").then(res=>{
        this.options = [];
        for(var i=0;i<res.data.length;i++){
          console.log(res.data[i].type)
          this.options.push({value:res.data[i].id,label:res.data[i].name + " " + res.data[i].classes});
